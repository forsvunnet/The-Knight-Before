...
namespace DragonBone
{
	...
	public class SpriteMesh : MonoBehaviour {
		...
		public Vector2[] uvs;
		public Color[] colors;//顶点颜色
		public int[] triangles;//三角形

		public BoneWeightClass[] weights;//权重 ,用于蒙皮动画
		public Matrix4x4[] bindposes; //用于蒙皮动画
		public Transform[] vertControlTrans;//顶点控制器，用于网格动画
		...
		[SerializeField]
		private Color m_color = Color.white;//用于动画控制
